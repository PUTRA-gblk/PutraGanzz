...
const starts = async (kurr = new WAConnection()) => {
	console.log(color('AYO MARI MENJAGA SOURCE CODE INI BIAR BERKEMBANG\n\n', 'orange'), color('\n======TERIMKASIH BANYAK KEPADA======\n•Aldy Fauzy\n•Kemol\n•ADI\n•KurrXd\n•YUDHA\n•PAJARn•Dcode Denpa\n•Finx\n•PutraGanzz\n•SELURUH SUBSCRIBERKU', 'yellow'))
	console.log(color('\n\nJANGAN DI JUAL  BRO😑\nKALAU ADA YG JUAL SURUH CHAT ©PutraGanzz\nWA 6285854721440', 'pink'))
    kurr.logger.level = 'warn'
    kurr.version = [2, 2143, 3]
    kurr.browserDescription = [ 'PutraGanzz', 'Chrome', '3.0' ]
    ...
    kurr.on('chat-update', async (message) => {
        ...
        ownerNumber = ["6285854721440@s.whatsapp.net","6285854721440@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
       ...
       otod = `${settings.NomorOwner}@s.whatsapp.net`
        ...
        kurr.on('group-participants-update', async (anu) => {
           mem = anu.participants[0]
			...
			gbutsan = [{buttonId:'SERAH',buttonText:{displayText:'Bully yok😏'},type:1}]
...
headerType: 4 }
			...
			gbutsan = [{buttonId:'SERAH',buttonText:{displayText:'Awokawok Out😂'},type:1}]
			mhan = await kurr.prepareMessage(mdata.id, buff, MessageType.image, {thumbnail: buff})
const buttonMessages = { imageMessage: mhan.message.imageMessage,
contentText: `${keluar}`,
